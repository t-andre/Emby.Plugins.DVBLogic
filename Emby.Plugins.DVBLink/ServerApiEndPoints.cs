...
namespace Emby.Plugins.DVBLink
{
	...
	[Route("/DVBLinkPlugin/Profiles", "GET", Summary = "Gets a list of streaming profiles")]
    ...
    /// <seealso cref="T:MediaBrowser.Model.Services.IReturn{System.Collections.Generic.List{System.String}}"/>
    /// <seealso cref="T:ServiceStack.IReturn{System.Collections.Generic.List{System.String}}"/>
    [Route("/DVBLinkPlugin/Channels", "GET", Summary = "Gets a list of channels")]
    ...
    [Route("/DVBLinkPlugin/Sessions", "GET", Summary = "Gets a list of sessions")]
	...
	[Route("/DVBLinkPlugin/Favourites", "GET", Summary = "Gets a list of Favourites channels")]
	...
	[Route("/DVBLinkPlugin/StopSession", "GET", Summary = "Stop the session")]
    ...
    /// <seealso cref="T:MediaBrowser.Model.Services.IReturn{System.Boolean}"/>
    /// <seealso cref="T:ServiceStack.IReturn{System.Boolean}"/>
    [Route("/DVBLinkPlugin/TestConnection", "GET", Summary = "Tests the connection to DVBLink")]
	...
	[Route("/DVBLinkPlugin/ServerStatus", "GET", Summary = "Get DVBLink Server Status")]
