...
{
    /// <summary> Information about the object item video. </summary>
    [XmlRoot("video_info")]
    public class ObjectItemVideoInfo
    {
        ...
        /// <summary>
        /// Query if this TSoft.TVServer.Entities.ObjectItemVideoInfo is video series. </summary>
        /// <returns> true if video series, false if not. </returns>
        public bool IsVideoSeries()
        {
